...
|---------|-------------|
| `networking_and_content_delivery` | Networking |
...
| `route_53_application_recovery_controller` | Route 53 ARC |
| `route_53_hosted_zone` | Hosted Zone |
| `route_53_resolver` | Route 53 Resolver |
| `elastic_ip_address` | Elastic IP |
| `network_access_control_list` | Network ACL |
| `router` | Router |
